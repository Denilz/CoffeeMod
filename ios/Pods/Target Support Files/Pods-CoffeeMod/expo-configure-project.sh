...
with_node \
  ...
  --target "/Users/danielt/Desktop/Daniel Tukav/projects/110/CoffeeMod/ios/Pods/Target Support Files/Pods-CoffeeMod/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-keep-awake" "expo-linear-gradient"
